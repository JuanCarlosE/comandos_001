...
app_name= "soldiers"
urlpatterns = [
    path("check/", views.phoneRegister), #Obtiene y envia el numero de celular para filtrar a partir de el.
    path("save/", views.asisRegister), #Guarda el intento de asistencia del usuario con o sin orden activa. 
    path("calendar/", views.viewCalendar), #Envia un calendario apartir del cual se podra observar los registros por dia.
    ...
    path("morosos/", views.viewMorosos), #Envia una lista con los usuarios "morosos" (que van mas de los 15 dias pagos.)
